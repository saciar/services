...
public class PorcentajeComercialesReport implements PorcentajeComercialesReportSEI,ReportService {
	...
	public PorcentajeGerencia[] findByRangeDate(int day1, int month1, int year1, 
		...
		return findByDateRange(startDate,endDate, whereClause(codVendedor,codUc));
	}
	...
	public int findTotalPptos(int day1, int month1, int year1, 
		...
		return getTotalPpto(startDate,endDate, whereClause(codVendedor,codUc));
	}
	...
	private int getTotalPpto(Date startDate, Date endDate, String where){
	...
	//private PorcentajeGerencia[] findByDateRange(Date startDate, Date endDate){
		...
		for (int i=0; i< results.length;i++){ 
			...
			else if((Integer)row[9] == 1 && (Integer)row[8] == 0)
