...
import crm.services.report.sei.PorcentajeGerenciaReportSEI;
import crm.services.sei.EstadoEventoManagerSEI;
import crm.services.util.HibernateUtil;

public class PorcentajeGerenciaReport implements PorcentajeGerenciaReportSEI,ReportService {
	...
	private String whereClause(long codVendedor, long codUc, long codLugar, long codEstado){
			
		String st = "";
		
		if(codVendedor!=0 && codUc!=0 && codLugar!= 0 && codEstado!= 0){
			st="and codVendedor = "+codVendedor+" and codUnidad = "+codUc+" and codLugar = "+codLugar+getEstadoActual(codEstado);
		}
		else if(codVendedor!=0 && codUc!=0 && codLugar!= 0 && codEstado == 0){
			st="and codVendedor = "+codVendedor+" and codUnidad = "+codUc+" and codLugar = "+codLugar;
		}
		else if(codVendedor!=0 && codUc!=0 && codLugar== 0 && codEstado!= 0){
		...
		//------------------------------------------------------------------------------------
			...
			st="and codVendedor = "+codVendedor+" and codLugar = "+codLugar+getEstadoActual(codEstado);
		}
		else if(codVendedor!=0 && codUc==0 && codLugar!= 0 && codEstado == 0){
			st="and codVendedor = "+codVendedor+" and codLugar = "+codLugar;
		}
		else if(codVendedor!=0 && codUc==0 && codLugar== 0 && codEstado!= 0){
		...
		//------------------------------------------------------------------------------------
			...
			st="and codUnidad = "+codUc+" and codLugar = "+codLugar+getEstadoActual(codEstado);
		}
		else if(codVendedor==0 && codUc!=0 && codLugar!= 0 && codEstado == 0){
			st="and codUnidad = "+codUc+" and codLugar = "+codLugar;
		}
		else if(codVendedor==0 && codUc!=0 && codLugar== 0 && codEstado!= 0){
		...
		//------------------------------------------------------------------------------------
			...
			st="and codLugar = "+codLugar+getEstadoActual(codEstado);
		}
		else if(codVendedor==0 && codUc==0 && codLugar!= 0 && codEstado == 0){
			st="and codLugar = "+codLugar;
		}
		else if(codVendedor==0 && codUc==0 && codLugar== 0 && codEstado!= 0){
	...
	private PorcentajeGerencia[] findByDateRange(Date startDate, Date endDate){
		Session session = HibernateUtil.abrirSession();
		...
		PorcentajeGerencia[] results = new PorcentajeGerencia[list.size()];
		for (int i=0; i< results.length;i++){ 
			results[i] = new PorcentajeGerencia();
