...
public class TipoCobradorManager implements TipoCobradorManagerSEI,WSDL2Service {

	public TipoCobrador getTipoCobradorById(String codigo) throws RemoteException {
		Session session = HibernateUtil.abrirSession();

		Criteria c = session.createCriteria(TipoCobrador.class);
		c.add(Expression.eq("codigo", codigo));
		c.add(Expression.eq("activo","S"));
		TipoCobrador a = (TipoCobrador) c.uniqueResult();
	...
	public TipoCobrador[] getAllTipoCobradores() throws RemoteException {
		...
		return (TipoCobrador[])list.toArray(new TipoCobrador[0]);
	}

	public TipoCobrador[] getAllTipoEventosTranslated(String lang) throws RemoteException {
		// TODO Auto-generated method stub
		return null;
	}

	public TipoCobrador[] findByField(String field,String value){
		Session session = HibernateUtil.abrirSession();
		Criteria c = session.createCriteria(TipoCobrador.class);
	...
	public void remove(String codigo) throws RemoteException {
		...
		try {
			...
			entity = (TipoCobrador) session.get(TipoCobrador.class, codigo);						
			entity.setActivo("N");
	...
	public void update(TipoCobrador cobrador) throws RemoteException {
		TipoCobrador te = null;
		Session session = null;
		Transaction tx = null;
		...
		try {
			...
			if (StringUtils.isBlank(cobrador.getCodigo())) {
				...
				te = (TipoCobrador) session.get(TipoCobrador.class, cobrador.getCodigo());
			}
	...
	public Object[] getTipoCobradoresReport() throws RemoteException {
		...
		List list = session.createQuery("select codigo,descripcion from TipoCobrador order by descripcion").list();
